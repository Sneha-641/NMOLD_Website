      ...
      <div className="bg-white p-10 rounded-lg shadow-md w-full max-w-4xl border border-blue-900">
        ...
        <form className="space-y-6 ">
          ...
          <div className="flex justify-between">
            <button type="button" className="px-10 py-2 bg-white text-gray-700 rounded-md border border-blue-600">Back</button>
            <button type="submit" className="px-10 py-2 bg-blue-600 text-white rounded-md">Request</button>
          </div>
        </form>
      </div>
    </div>
