...
const Services = () => {
  ...
  const renderHomeContent = () => {
    switch (selectedService) {
      case 'app':
        return (
          <>
            <h2 className="text-4xl font-bold head-left-img">Converting Your App Ideas into Reality</h2>
      ...
      case 'uiux':
        return (
          <>
            <h2 className="text-4xl font-bold head-left-img">UI Development as Per Your Needs</h2>
            <p className="pt-4 text-[#6A6A6A]" style={{
              fontSize: "20px",
              fontWeight: "400",
              lineHeight: "32px",
      ...
      case 'digital':
        return (
          <>
            <h2 className="text-4xl font-bold head-left-img ">Crafting Memorable, Innovative Digital Experiences.</h2>
            <p className="pt-4 text-[#6A6A6A]" style={{
              fontSize: "20px",
              fontWeight: "400",
              lineHeight: "32px",
      ...
      default:
        return (
          <>
            <h2 className="text-4xl font-bold head-left-img">We Create Experience Not Just Webs</h2>
            <p className="pt-4 text-[#6A6A6A]" style={{
              fontSize: "20px",
              fontWeight: "400",
              lineHeight: "32px",
  ...
  return (
    <div>
      ...
      <section className="mt-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 prose p-2 main-div mx-auto px-52">
          <div className="p-2 ">
            {renderHomeContent()}
            <div className="mt-8">
              <button className="bg-[var(--theme)] text-white px-4 py-2 rounded">Schedule a Meeting</button>
              <button className="bg-white text-[var(--theme)] px-4 py-2 border border-blue-500 rounded ml-2">Contact Us</button>
            </div>
          </div>
          <div className="p-2">
      ...
      {/* Services Section */}
      <section className="mt-[6rem] py-12 section-service">
